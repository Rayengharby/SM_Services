...
@include('inc.admin.nav')
        <div class="content">
          <div class="pb-5">
            <div class="row g-5">
              <center>  <h1><font  face="time new roman">Hello Administrateur</font></h1></center>

            </div>
          </div>
          <h3><font face="time new roman">Liste des admin</font></h3>
          <hr/>
          <a data-bs-toggle="modal" data-bs-target="#tooltipModal" class="btn btn-primary mt-3">Ajouter admin </a>
          <div class="mt-4">
                    ...
                    <td>{{$index +1}}</td>
                      ...
                      <td>{{$s->email}}</td>
                        ...
                        <td>
                            ...
                            <a onclick="return confirm ('voulez-vous vraiment supprimer cette admin?')" href="/admin/admin/{{ $s->id }}/delete" class="btn btn-danger">Supprimer</a>
                        </td>
...
<div class="modal fade" id="tooltipModal" tabindex="-1" aria-labelledby="tooltipModallLabel" aria-hidden="true" style="display: none;">
  ...
  <div class="mb-0">
      ...
      <input name="email" class="form-control" id="exampleFormControlInput1" type="email" placeholder="taper email ...">
       @error('email')
      <div class="alert alert-danger">
      {{$message}}
      </div>
  ...
  <div class="mb-3">
    ...
    <input name="password" class="form-control" id="exampleFormControlInput1" type="password" placeholder="donner le mot de passe ...">
    @error('password')
    <div class="alert alert-danger">
    {{$message}}
    </div>
